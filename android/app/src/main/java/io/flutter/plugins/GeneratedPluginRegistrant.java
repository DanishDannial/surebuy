...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.vexellab.flutter_windowmanager_plus.FlutterWindowManagerPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin flutter_windowmanager_plus, com.vexellab.flutter_windowmanager_plus.FlutterWindowManagerPlugin", e);
    }
    try {
    ...
    try {
      ...
      Log.e(TAG, "Error registering plugin uni_links5, name.avioli.unilinks.UniLinksPlugin", e);
    }
    try {
